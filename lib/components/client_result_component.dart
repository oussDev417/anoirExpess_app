...
class ClientResultComponent extends StatefulWidget {
  Course course;
  ClientResultComponent({required this.course});

  @override
  State<ClientResultComponent> createState() => _ClientResultComponentState();
}

class _ClientResultComponentState extends State<ClientResultComponent> {
  UserService userService = UserService();
  User? author;
  getAuthor() async {
    User? u = await userService.getUserById(widget.course.authorId!);
    setState(() {
      author = u;
    });
  }
          ...
          child: ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                try{
                  if(author != null){
                    launchUrl(Uri.parse('tel://${author!.phone}'));
                  }
                }
                catch(e){
